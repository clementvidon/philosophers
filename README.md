...
The code is written in accordance with ANSI c89 and 42 C coding style and ***all the functions are documented with docstrings*** (start from the **[header](include/philo.h)** file). 
