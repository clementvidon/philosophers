...
where each philosopher is a thread and mutexes are used to prevent deadlocks.  The code is written in accordance with 42 coding style and ***all the functions are documented with docstrings*** (start from the **[header](include/philo.h)** file). 
